          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              ...
              <div className="hidden sm:-my-px sm:ml-8 sm:flex sm:space-x-8">
                ...
                <Link href="/events/new" className="inline-flex items-center px-1 pt-1 text-sm font-medium text-slate-900 border-b-2 border-blue-500">
                  Create Event
                </Link>
              </div>
            </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="mb-8">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <h1 className="text-4xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">Create New Event</h1>
            </div>
            <p className="text-slate-600">Add a new event to your calendar</p>
          </div>
